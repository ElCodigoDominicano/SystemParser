...
async def create_windows_process(command_key):
    ...
    Parameter command_key: a list of strings separated by commas.
    Precondition command_key: a valid Win32 provider class string (check examples)
...
async def stream_parser(stream_iter) -> dict:
    """*Coroutine awaitable function*
